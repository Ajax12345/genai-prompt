...
class DB:
    DB_URL = os.environ.get('DATABASE_URL', 'postgresql://jamesp:NOiMxLDRD3ra3QGrIxopS0XdJANBRxdZ@dpg-da2945rjan9c73a3icgg-a.virginia-postgres.render.com/genai_cf6h')
